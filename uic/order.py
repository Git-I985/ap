...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.groupBox, 8, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Изменить/Создать заказ"))
        self.label_4.setText(_translate("MainWindow", "Статус заказа"))
        self.label_3.setText(_translate("MainWindow", "Заказчик"))
        self.label_2.setText(_translate("MainWindow", "Адрес доставки"))
        self.label.setText(_translate("MainWindow", "Дата доставки"))
