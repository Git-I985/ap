...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(_translate("MainWindow", "Статусы поставок"))
        self.pushButton_3.setText(_translate("MainWindow", "Изменить поставку"))
        self.pushButton_2.setText(_translate("MainWindow", "Удалить поставку"))
        self.pushButton.setText(_translate("MainWindow", "Добавить поставку"))
        self.pushButton_5.setText(_translate("MainWindow", "Найти поставку"))
